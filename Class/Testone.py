...
if __name__ == '__main__':
    ...
    # 一找多
    # 定义标准字符串
    stand = "DOT 052 TLTLBKDOT 057 TLTLBK xxx ABOUT THIS"
    # 定义数据列表
    data = ["AH IE NAII","E","SS T AE","","","006 1(59091209","C0000 10 R","XXX 1 2 ","XX 1 50 10","L TE","CE",
            " () ","CE","","CAAO","HNIHO NI GON","   ","()","CSEE","2","0","S","94744","","","","","79464",
            "C","","","","000","","000","","I","","","I","冏"]
